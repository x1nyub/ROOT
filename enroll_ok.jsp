...
pstmt = conn.prepareStatement("INSERT INTO company (company_num, company_subject, company_name, company_scale, company_career, company_education, company_location, company_fulltime, company_field, company_image, company_url, company_period, company_q1, company_q2) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
